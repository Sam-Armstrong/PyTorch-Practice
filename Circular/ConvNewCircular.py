...
class ConvNewCircular(nn.Module):
    def __init__(self):
        super(ConvNewCircular, self).__init__()
        ...
        self.conv3 = nn.Conv2d(1, 6, kernel_size = 3, padding = 1)
        self.conv4 = nn.Conv2d(6, 1, kernel_size = 1, padding = 0)
...
def train_model():
    ...
    model = ConvNewCircular().to(device)
