...
from NewCircular import NewCircular

class FFCircular(nn.Module):
    def __init__(self):
        super(FFCircular, self).__init__()
...
for epoch in range(num_epochs):
    ...
    for batch_idx, (data, labels) in enumerate(train_dataloader):
        ...
        #print(torch.max(model.fc2.weight))
        #print(torch.max(model.fc3.weight))
        #print(torch.max(model.fc4.weight))
