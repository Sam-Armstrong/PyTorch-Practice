...
Description: Implementation of the Circular neural network architecture that uses dense & conv rather than sparse layers,
...
class CircularNN(nn.Module):
    def __init__(self):
        ...
        self.bn3 = nn.BatchNorm1d(2352)
        self.bn4 = nn.BatchNorm1d(2352)

        self.conv1 = nn.Conv2d(1, 3, kernel_size = 3, padding = 1)
        self.conv2 = nn.Conv2d(3, 1, kernel_size = 3, padding = 1)

        self.fc1 = nn.Linear(2352, 2352)
        self.fc2 = nn.Linear(2352, 2500)
        self.fc3 = nn.Linear(2500, 2500)
        self.fc4 = nn.Linear(2500, 2352)
        self.fc5 = nn.Linear(2352, 2352)
